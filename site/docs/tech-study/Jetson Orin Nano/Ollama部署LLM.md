...
![Ollama 安装信息](./Ollama部署LLM-imgs/Ollama部署LLM-imgs-1.png)
...
![Ollama 验证安装](./Ollama部署LLM-imgs/Ollama部署LLM-imgs-2.png)
...
![部署 DeepSeek 模型](./Ollama部署LLM-imgs/Ollama部署LLM-imgs-3.png)
...
![局域网访问成功](./Ollama部署LLM-imgs/Ollama部署LLM-imgs-4.png)
...
![LangChain 调用结果](./Ollama部署LLM-imgs/Ollama部署LLM-imgs-6.png)
...
![Open WebUI 部署成功](./Ollama部署LLM-imgs/Ollama部署LLM-imgs-5.png)
