...
const ADMIN_BACKEND_DIR = resolve(REPO_ROOT, 'admin-dev', 'backend')
const ADMIN_FRONTEND_DIR = resolve(REPO_ROOT, 'admin-dev', 'frontend')
...
const venvPython = resolve(ADMIN_BACKEND_DIR, '.venv', 'Scripts', 'python.exe')
run(venvPython, ['main.py'], ADMIN_BACKEND_DIR, '管理后端', green)

// 3. 管理后台前端（Vite）
run('npm', ['run', 'dev'], ADMIN_FRONTEND_DIR, '管理前端', yellow)
